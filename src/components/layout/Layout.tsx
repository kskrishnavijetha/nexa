...
import { BarChart, FileText, History, Settings, ClipboardList, MessageSquare, Palette, ShieldCheck, Bug, PanelRightOpen } from 'lucide-react';
                ...
                <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={location.pathname === '/integrations'}>
                      <Link to="/integrations" draggable="false">
