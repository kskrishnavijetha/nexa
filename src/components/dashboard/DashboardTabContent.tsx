          ...
          {reports.length > 0 ? (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {selectedReport ? (
                  // Show specific report compliance scores
                  <>
                    <div className="bg-slate-50 p-4 rounded-md">
                      <h3 className="font-medium mb-2">GDPR</h3>
                      <div className={`text-2xl font-bold ${
                        selectedReport.gdprScore >= 70 ? 'text-green-600' : 'text-red-600'
                      }`}>
                        {selectedReport.gdprScore}%
                      </div>
                      <p className="text-xs text-muted-foreground mt-1">
                        {selectedReport.documentName}
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-md">
                      ...
                      <div className={`text-2xl font-bold ${
                        selectedReport.hipaaScore >= 70 ? 'text-green-600' : 'text-red-600'
                      }`}>
                        {selectedReport.hipaaScore}%
                      </div>
                      <p className="text-xs text-muted-foreground mt-1">
                        {selectedReport.documentName}
                      </p>
                    ...
                    <div className="bg-slate-50 p-4 rounded-md">
                      ...
                      <div className={`text-2xl font-bold ${
                        selectedReport.soc2Score >= 70 ? 'text-green-600' : 'text-red-600'
                      }`}>
                        {selectedReport.soc2Score}%
                      </div>
                      <p className="text-xs text-muted-foreground mt-1">
                        {selectedReport.documentName}
                      </p>
