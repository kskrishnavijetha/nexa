...
const PaymentButtons: React.FC<PaymentButtonsProps> = ({
  ...
  const requiresUpgrade = tier !== 'free' || needsUpgrade;
  ...
  const buttonText = isChangingPlan
    ...
    : tier === 'free'
    ? (requiresUpgrade ? 'Select a Paid Plan' : 'Activate Free Plan')
