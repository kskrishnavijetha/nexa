...
export const saveSubscription = (plan: string, paymentId: string, billingCycle: 'monthly' | 'annually' = 'monthly') => {
  const pricingTiers = {
    ...
    basic: { scans: 10, days: 30 }, // Always 30 days for monthly
    pro: { scans: 50, days: 30 }, // Always 30 days for monthly
    enterprise: { scans: 999, days: 30 }, // Using 999 to represent unlimited, always 30 days for monthly
  };
