      ...
      if (user?.id) {
        ...
        if (userReports.length === 0) {
          toast.info('Welcome to your dashboard! Start by running a document scan.', {
            action: { label: 'Scan Document', onClick: () => navigate('/document-analysis') },
            duration: 5000,
          });
        }
      }
    ...
    <SelectedReportProvider>
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-center justify-between">
              <div>
                <h3 className="text-base font-medium text-slate-700">
                  Your {subscription.plan} Plan Usage
                </h3>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          ...
          <TabsContent value="compliance"><DashboardTabContent activeTab="compliance" /></TabsContent>
          <TabsContent value="risks"><DashboardTabContent activeTab="risks" /></TabsContent>
          <TabsContent value="actions"><DashboardTabContent activeTab="actions" /></TabsContent>
        </Tabs>
